$(document).ready(function() {
    ...
    $('div.ns2-form form').submit(function(event) {
       ...
       if (eval(e_value) > 0) {
           ...
           var ajax_loading = "<img src='$MEDIA_URL$images/ajax/ajax_loader.gif' alt='Loading ...' style='width: auto; height: auto; border: 0; margin: 0; padding-left: 44.5%; padding-right: 44.5%; padding-top: 25px; padding-bottom: 25px;' />"
    ...
    $('#expand').click(function(event) {
       event.preventDefault();
       if ($('#expand').attr('src') == '$MEDIA_URL$images/new/ant/sort_up_24.png') {
            $('div#traceVisible').css('visibility', 'hidden');
            $('#expand').attr('src', '$MEDIA_URL$images/new/ant/sort_down_24.png');
            $('textarea.ns2-code-trace').css('height', '0px');
       } else {
           $('div#traceVisible').css('visibility', 'visible');
           $('#expand').attr('src', '$MEDIA_URL$images/new/ant/sort_up_24.png');
