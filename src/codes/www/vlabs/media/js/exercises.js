var ajax_loading = "<img src='$MEDIA_URL$images/ajax/ajax_loader.gif' alt='Loading ...' \n\
    ...
    $(document).ready(function() {
        ...
        $("#ddlExercises").change(function() {
           ...
           if (eval(e_value) > 0) {
               //alert('"' + dutils.urls.resolve('load_exercise', { exercise_id: e_value, }) + '"');
               $("#problem_statement").html(ajax_loading);
               $("#problem_statement").load(
                    /** Remove hardcoded URLs -- Barun [27 Feb 2013] */
                    ...
                    function(responseText, textStatus, XMLHttpRequest) {
                        ...
                        var target_url = dutils.urls.resolve('load_workspace', { exercise_id: e_value, object_id: $("#hObjId").val(), problem_id: e_text,});
