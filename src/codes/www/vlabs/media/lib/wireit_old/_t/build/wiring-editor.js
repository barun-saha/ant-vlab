...
YAHOO.lang.extend(WireIt.Wire, WireIt.CanvasElement, {
    ...
    */
   redraw: function() {
        var edgeType = document.getElementByID('hEdgeType').value;
        alert(edgeType);
   ...
   render: function() {
      ...
      if(this.options.ddHandle) {
         ...
         if(this.options.title) {
             ...
             // Add an editable label to the containers
             ...
             this.ddHandle.appendChild(titleDiv); 
             // End
         }
...
YAHOO.lang.extend(WireIt.ImageContainer, WireIt.Container, {
   ...
   setOptions: function(options) {
      ...
      this.options.title = "ImageContainer";
   },
...
YAHOO.lang.extend(WireIt.MyImageContainer, WireIt.Container, {
    ...
    */
    setOptions: function(options) {
        ...
        this.options.className = options.className || "WireIt-Container WireIt-MyImageContainer";

        // Overwrite default value for options:
        this.options.resizable = (typeof options.resizable == "undefined") ? false : options.resizable;
        this.options.ddHandle = (typeof options.ddHandle == "undefined") ? false : options.ddHandle;
        this.options.title = "MyImageContainer";
    },
