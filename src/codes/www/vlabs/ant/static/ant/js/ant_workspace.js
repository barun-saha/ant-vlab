$(document).ready(function() {
    ...
    $('div.ns2-form form').submit(function(event) {
       ...
       if (eval(e_value) > 0) {
           ...
           ajax_loading += "' alt='Loading ...' style='width: auto; height: auto; border: 0; margin: 0; padding-left: 44.5%; padding-right: 44.5%; padding-top: 25px; padding-bottom: 25px;' />";
    ...
    $('#expand').click(function(event) {
       event.preventDefault();
       if ($('#expand').attr('src') == get_static('ant/images/new/ant/sort_up_24.png') {
            $('div#traceVisible').css('visibility', 'hidden');
            $('#expand').attr('src', get_static('ant/images/new/ant/sort_down_24.png'));
            $('textarea.ns2-code-trace').css('height', '0px');
       } else {
           $('div#traceVisible').css('visibility', 'visible');
           $('#expand').attr('src', get_static('ant/images/new/ant/sort_up_24.png'));
