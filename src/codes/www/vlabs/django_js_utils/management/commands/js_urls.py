...
# Added by Barun -- 26 Feb 2013
_PREFIX_ = '/cse28/'
#

# List of apps used in this project -- used to filter the URLs
APPS_LIST = ('ant', 'ns2trace', 'djcelery', 'comments',)
FILTER_PATTERNS = []
